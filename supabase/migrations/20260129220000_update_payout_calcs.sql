-- Update Payout Calculation with Fixed Virtual Fee (10k COP)
-- Replaces previous function
...
BEGIN
  ...
  FOR _appointment IN
    SELECT 
      ...
      a.start_time,
      a.end_time,
      a.is_virtual, -- Added is_virtual check
  ...
  LOOP
    ...
    IF _appointment.is_virtual THEN
       -- Fixed cost for virtual appointments (10,000 COP)
       -- This acts as the "room rental" equivalent for virtual sessions
       _room_cost := 10000;
    ...
    INSERT INTO public.payouts (
      ...
      _room_cost,
      _doctor_payout,
      _room_cost, -- clinic_revenue = room_rental_cost (includes virtual fee)
